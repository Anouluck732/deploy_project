<template>
    <div class="container mx-auto p-4 pt-16 bg-white font-noto-sans-lao">
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center mb-2">
          ...
          <span class="text-sm text-gray-600">{{ product.review }} ລີວິວ</span>
          <span class="mx-2 text-gray-300">|</span>
          <span class="text-sm text-gray-600">{{ product.sold }} ຍອດຂາຍ</span>
        </div>
      ...
      <div class="mb-6">
        <div class="flex border-b">
          <button class="py-2 px-4 font-semibold text-red-600 border-b-2 border-red-600">ກ່ຽວກັບສິນຄ້າ</button>
          <button class="py-2 px-4 font-semibold text-gray-500">ການລີວິວ</button>
        </div>
        <div class="py-4">
